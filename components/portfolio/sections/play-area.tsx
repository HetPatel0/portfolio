...
export function PlayArea({ playerX, isJumping, dayMode, mounted }: PlayAreaProps) {
  return (
    <div className="grid gap-4">
      <div className={`${minecraftPanelClass} avatar-card relative min-h-[24rem] overflow-hidden bg-[#203245] p-5`}>
        <Image
        ...
        <div className="absolute bottom-[5.2rem] left-4 bg-[rgba(21,16,12,0.82)] px-2.5 py-1 font-[var(--font-display)] text-[0.55rem] uppercase tracking-[0.08em] text-[#ffe093]">
      ...
      >
        <div>
          <span className="font-[var(--font-display)] text-[0.56rem] uppercase tracking-[0.08em] text-[#ffe093]">
            Biome
          </span>
