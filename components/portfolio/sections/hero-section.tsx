...
export function HeroSection({ onNavigate, playerX, isJumping, dayMode, mounted }: HeroSectionProps) {
  return (
    ...
    >
      <div>
        <p className="font-(--font-display) text-[0.6rem] uppercase tracking-[0.08em] text-[#ffe093]">
          Spawn Point
        </p>
        <h1 className="mt-4 font-(--font-display) text-[clamp(1.9rem,5vw,3.9rem)] leading-[1.15] text-[#fff4d1] [text-shadow:4px_4px_0_rgba(0,0,0,0.3)]">
          Hi, I&apos;m Your Name
        </h1>
